...
type DevDrawerProps = Pick<AlexaSession, "turns" | "voiceOut" | "setVoiceOut" | "agent" | "agentNote" | "cooldownUntil">;
...
const DevDrawer = ({ turns, voiceOut, setVoiceOut, agent, agentNote, cooldownUntil }: DevDrawerProps) => {
